                ...
                child: StatefulBuilder(
                  builder: (BuildContext context,
                    ...
                    return AlertDialog(
                      ...
                      content: Text(
                        "the default start is the ${startValue ~/
                            1000}th second and the end is the  ${endTemp ~/
                            1000}th second\n "
            ...
            IconButton(
              ...
              onPressed: !isLoading ? () async {
                ...
                await trimmer.saveTrimmedVideo(
                  ffmpegCommand:
                  "-af \"volume=enable='between(t,${StartCurrentValue -
                      startValue ~/ 1000},${EndCurrentValue -
                      startValue ~/ 1000})':volume=0\" "
                  ,
                  ...
                  onSave: (String? outputPath) async {
                    ...
                    String title = widget.flag.title != null ? "${DateTime
                        .now()
                        .microsecondsSinceEpoch}_${widget.flag.title}" : DateTime
                        .now()
                        .microsecondsSinceEpoch
                        .toString();
                    String newPath =
                        "${valuee.path}/$title.mp4";
                    ...
                    widget.items
                      ...
                      String command = '-i $newPath -i $logoPath -filter_complex overlay=10:10 -codec:a copy ${outputPath
                          .path}';
              ...
              child: TrimEditor(
                ...
                onChangeEnd: (value) {
                  setState(() {
                    endValue = value / 1000;
                    endTemp = endValue;
                    trimmer.videoPlayerController!.seekTo(
